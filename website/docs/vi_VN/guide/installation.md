...
Tải xuống APP KernelSU manager từ [GitHub Releases](https://github.com/khoi2mai/BunnySU/releases) và cài đặt nó vào thiết bị của bạn:
...
1. Từ [Release page](https://github.com/khoi2mai/BunnySU/releases) của KernelSU, tải xuống gói zip bắt đầu bằng AnyKernel3 phù hợp với phiên bản điện thoại của bạn; ví dụ: phiên bản kernel của điện thoại là `android12-5.10. 66`, thì bạn nên tải xuống tệp `AnyKernel3-android12-5.10.66_yyyy-MM.zip` (trong đó `yyyy` là năm và `MM` là tháng).
...
Bạn có thể tải xuống boot.img từ [GitHub Release](https://github.com/khoi2mai/BunnySU/releases), xin lưu ý rằng bạn nên sử dụng đúng phiên bản boot.img. Ví dụ: nếu thiết bị của bạn hiển thị kernel `android12-5.10.101` , bạn cần tải xuống `android-5.10.101_yyyy-MM.boot-<format>.img`. (Giữ KMI nhất quán!)
