...
2. 在您要執行的命令前新增 `nsenter --mount=/proc/1/ns/mnt` 即可使此命令在全域 mount namespace 下執行。KernelSU 本身也使用了 [這種方法](https://github.com/khoi2mai/BunnySU/blob/77056a710073d7a5f7ee38f9e77c9fd0b3256576/manager/app/src/main/java/com/bunny/su/ui/util/KsuCli.kt#L115)
