...
Java_com_bunny_su_Natives_getVersion(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_bunny_su_Natives_getSuperuserCount(JNIEnv *env, jobject) {
...
Java_com_bunny_su_Natives_isSafeMode(JNIEnv *env, jclass clazz) {
    return is_safe_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_isLkmMode(JNIEnv *env, jclass clazz) {
    return is_lkm_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_isLateLoadMode(JNIEnv *env, jclass clazz) {
    return is_late_load_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_isManager(JNIEnv *env, jclass clazz) {
    return is_manager();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_isPrBuild(JNIEnv *env, jclass clazz) {
    return is_pr_build();
}
...
Java_com_bunny_su_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("com/bunny/su/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("com/bunny/su/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_uidShouldUmount(JNIEnv *env, jobject thiz, jint uid) {
    return uid_should_umount(uid);
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_isSuEnabled(JNIEnv *env, jobject thiz) {
    return is_su_enabled();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_setSuEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_su_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_isKernelUmountEnabled(JNIEnv *env, jobject thiz) {
    return is_kernel_umount_enabled();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_bunny_su_Natives_setKernelUmountEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_kernel_umount_enabled(enabled);
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_bunny_su_Natives_getUserName(JNIEnv *env, jobject thiz, jint uid) {
...
Java_com_bunny_su_magica_AppZygotePreload_forkDontCareAndExecKsud(JNIEnv *env, jclass clazz,
